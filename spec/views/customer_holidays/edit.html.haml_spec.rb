...
describe "customer_holidays/edit.html.haml" do
  before(:each) do
  ...
  it "renders the edit customer_holiday form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => customer_holiday_path(@customer_holiday), :method => "post" do
